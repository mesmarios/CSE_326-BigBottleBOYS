...
(1, 'admin_main', 'admin@tepak.cy', '$2y$12$HI9gYHu.mZXz8HD5uMPPDeVNlexHYYcPHnZACY6tAXZETLbTqwKKW', 'Γιάννης', 'Παπαδόπουλος', '+35799111111', 'Λεμεσός, Κύπρος', '1985-02-14', 'PhD', 'University of Cyprus', 'Educational Technology', 12, 'Κεντρικός διαχειριστής του συστήματος και συντονιστής ακαδημαϊκών διαδικασιών.', 'admin', '2026-01-05 09:00:00', '2026-04-22 11:30:00'),
(2, 'hr_manager', 'hr@tepak.cy', '$2y$12$HI9gYHu.mZXz8HD5uMPPDeVNlexHYYcPHnZACY6tAXZETLbTqwKKW', 'Μαρία', 'Αντωνίου', '+35799222222', 'Λευκωσία, Κύπρος', '1988-07-09', 'MBA', 'Open University of Cyprus', 'Human Resources', 9, 'Υπεύθυνη ανθρώπινου δυναμικού για προσλήψεις και παρακολούθηση onboarding.', 'hr_manager', '2026-01-10 10:15:00', '2026-04-23 10:45:00'),
(3, 'evaluator_one', 'evaluator1@tepak.cy', '$2y$12$HI9gYHu.mZXz8HD5uMPPDeVNlexHYYcPHnZACY6tAXZETLbTqwKKW', 'Ανδρέας', 'Νικολάου', '+35799333333', 'Πάφος, Κύπρος', '1979-03-22', 'PhD', 'Aristotle University', 'Computer Science', 14, 'Ακαδημαϊκός αξιολογητής για τεχνικά μαθήματα και εργαστήρια.', 'evaluator', '2026-01-12 12:00:00', '2026-04-18 15:00:00'),
(4, 'evaluator_two', 'evaluator2@tepak.cy', '$2y$12$HI9gYHu.mZXz8HD5uMPPDeVNlexHYYcPHnZACY6tAXZETLbTqwKKW', 'Ελένη', 'Γεωργίου', '+35799444444', 'Λάρνακα, Κύπρος', '1981-11-03', 'PhD', 'University of Patras', 'Digital Systems', 11, 'Αξιολογήτρια για ανακοινώσεις εργαστηρίων και πρακτικών μαθημάτων.', 'evaluator', '2026-01-15 09:40:00', '2026-04-19 16:10:00'),
(5, 'candidate_one', 'candidate1@example.com', '$2y$12$HI9gYHu.mZXz8HD5uMPPDeVNlexHYYcPHnZACY6tAXZETLbTqwKKW', 'Μάριος', 'Σιήττας', '+35799555555', 'Λεμεσός, Κύπρος', '1998-06-01', 'MSc', 'Tsinghua University', 'Web Engineering', 4, 'Υποψήφιος με εμπειρία σε web εφαρμογές, PHP και ανάπτυξη διεπαφών.', 'candidate', '2026-02-01 08:20:00', '2026-04-24 14:00:00'),
(6, 'candidate_two', 'candidate2@example.com', '$2y$12$HI9gYHu.mZXz8HD5uMPPDeVNlexHYYcPHnZACY6tAXZETLbTqwKKW', 'Χρίστος', 'Παύλου', '+35799666666', 'Λευκωσία, Κύπρος', '1996-09-18', 'MSc', 'University of Cyprus', 'Data Systems', 5, 'Εστιάζει σε συστήματα βάσεων, ποιότητα λογισμικού και διαχείριση δεδομένων.', 'candidate', '2026-02-03 10:10:00', '2026-04-24 14:05:00'),
(7, 'candidate_three', 'candidate3@example.com', '$2y$12$HI9gYHu.mZXz8HD5uMPPDeVNlexHYYcPHnZACY6tAXZETLbTqwKKW', 'Άννα', 'Ιωάννου', '+35799777777', 'Λάρνακα, Κύπρος', '1997-12-12', 'MSc', 'University of Patras', 'Embedded Systems', 3, 'Υποψήφια με πρακτική εμπειρία σε εργαστηριακή υποστήριξη και embedded συστήματα.', 'candidate', '2026-02-05 11:25:00', '2026-04-24 14:10:00'),
(8, 'specialist_one', 'specialist1@tepak.cy', '$2y$12$HI9gYHu.mZXz8HD5uMPPDeVNlexHYYcPHnZACY6tAXZETLbTqwKKW', 'Λουκάς', 'Δημητρίου', '+35799888888', 'Λεμεσός, Κύπρος', '1989-04-05', 'MSc', 'Cyprus University of Technology', 'Web Platforms', 8, 'Προσληφθείς ειδικός επιστήμονας με ενεργές αναθέσεις σε web και database courses.', 'specialist', '2026-01-20 09:10:00', '2026-04-24 13:30:00'),
(9, 'specialist_two', 'specialist2@tepak.cy', '$2y$12$HI9gYHu.mZXz8HD5uMPPDeVNlexHYYcPHnZACY6tAXZETLbTqwKKW', 'Κατερίνα', 'Θεοδώρου', '+35799999999', 'Πάφος, Κύπρος', '1990-10-27', 'MSc', 'University of Nicosia', 'Digital Learning', 7, 'Προσληφθείσα ειδικός επιστήμονας με μεικτή κατάσταση πρόσβασης σε μαθήματα.', 'specialist', '2026-01-22 14:00:00', '2026-04-24 13:45:00');
