...
('admin_giannis', 'admin@tepak.cy', '$2y$10$44FLgpptREMY9xddnKYnFeuFkxxgU1FlCdB9fz3TmLf33yFemmGFq', 'Γιάννης', 'Παπαδόπουλος', '+357 22 894556', 'Λευκωσία, Κύπρος', 'admin'),
('admin_maria', 'admin2@tepak.cy', '$2y$10$44FLgpptREMY9xddnKYnFeuFkxxgU1FlCdB9fz3TmLf33yFemmGFq', 'Μαρία', 'Χατζηιωάννου', '+357 22 894557', 'Λεμεσός, Κύπρος', 'admin'),
('hr_dimitris', 'hr@tepak.cy', '$2y$10$44FLgpptREMY9xddnKYnFeuFkxxgU1FlCdB9fz3TmLf33yFemmGFq', 'Δημήτρης', 'Οικονόμου', '+357 22 894558', 'Λάρνακα, Κύπρος', 'user'),
('hr_elena', 'hr2@tepak.cy', '$2y$10$44FLgpptREMY9xddnKYnFeuFkxxgU1FlCdB9fz3TmLf33yFemmGFq', 'Έλενα', 'Δημοσθένους', '+357 22 894559', 'Αμμόχωστος, Κύπρος', 'user'),
('evaluator_antonis', 'evaluator1@tepak.cy', '$2y$10$44FLgpptREMY9xddnKYnFeuFkxxgU1FlCdB9fz3TmLf33yFemmGFq', 'Αντώνης', 'Κωνσταντίνου', '+357 22 894560', 'Λευκωσία, Κύπρος', 'user'),
('evaluator_sofia', 'evaluator2@tepak.cy', '$2y$10$44FLgpptREMY9xddnKYnFeuFkxxgU1FlCdB9fz3TmLf33yFemmGFq', 'Σοφία', 'Βασιλειάδη', '+357 22 894561', 'Λευκωσία, Κύπρος', 'user'),
('evaluator_nikolas', 'evaluator3@tepak.cy', '$2y$10$44FLgpptREMY9xddnKYnFeuFkxxgU1FlCdB9fz3TmLf33yFemmGFq', 'Νικόλαος', 'Ζάγουρας', '+357 22 894562', 'Λεμεσός, Κύπρος', 'user'),
('candidate_1', 'candidate1@example.com', '$2y$10$44FLgpptREMY9xddnKYnFeuFkxxgU1FlCdB9fz3TmLf33yFemmGFq', 'Παναγιώτης', 'Κυριακίδης', '+357 96 123456', 'Λευκωσία, Κύπρος', 'user'),
('candidate_2', 'candidate2@example.com', '$2y$10$44FLgpptREMY9xddnKYnFeuFkxxgU1FlCdB9fz3TmLf33yFemmGFq', 'Αλέξανδρος', 'Πιερίδης', '+357 96 234567', 'Λεμεσός, Κύπρος', 'user'),
('candidate_3', 'candidate3@example.com', '$2y$10$44FLgpptREMY9xddnKYnFeuFkxxgU1FlCdB9fz3TmLf33yFemmGFq', 'Μαρία', 'Φιλίππου', '+357 96 345678', 'Λάρνακα, Κύπρος', 'user'),
('candidate_4', 'candidate4@example.com', '$2y$10$44FLgpptREMY9xddnKYnFeuFkxxgU1FlCdB9fz3TmLf33yFemmGFq', 'Ιωάννης', 'Σταθόπουλος', '+357 96 456789', 'Πάφος, Κύπρος', 'user'),
('candidate_5', 'candidate5@example.com', '$2y$10$44FLgpptREMY9xddnKYnFeuFkxxgU1FlCdB9fz3TmLf33yFemmGFq', 'Αναστασία', 'Μιχαλοπούλου', '+357 96 567890', 'Λευκωσία, Κύπρος', 'user'),
('specialist_1', 'specialist1@tepak.cy', '$2y$10$44FLgpptREMY9xddnKYnFeuFkxxgU1FlCdB9fz3TmLf33yFemmGFq', 'Ανδρέας', 'Λοΐζου', '+357 22 894563', 'Λευκωσία, Κύπρος', 'user'),
('specialist_2', 'specialist2@tepak.cy', '$2y$10$44FLgpptREMY9xddnKYnFeuFkxxgU1FlCdB9fz3TmLf33yFemmGFq', 'Νίκη', 'Αντωνιάδη', '+357 22 894564', 'Λεμεσός, Κύπρος', 'user'),
('specialist_3', 'specialist3@tepak.cy', '$2y$10$44FLgpptREMY9xddnKYnFeuFkxxgU1FlCdB9fz3TmLf33yFemmGFq', 'Χριστόφορος', 'Δημοσθένης', '+357 22 894565', 'Λάρνακα, Κύπρος', 'user');
...
(1, 1, 1, 1, 'Ειδικός Επιστήμονας - Ηλεκτρικές Μηχανές', 'Αναζητούμε ειδικό επιστήμονα για τη διδασκαλία και έρευνα στο πεδίο των ηλεκτρικών μηχανών', 'Πτυχίο ή μεταπτυχιακό στη σχετική ειδικότητα, ελάχιστο 2 χρόνια εμπειρία', 1, 'published'),
(1, 1, 2, 5, 'Ειδικός Επιστήμονας - Δομές Δεδομένων', 'Αναζητούμε ειδικό επιστήμονα για τη διδασκαλία και έρευνα στο πεδίο των δομών δεδομένων', 'Πτυχίο ή μεταπτυχιακό στη σχετική ειδικότητα, ελάχιστο 3 χρόνια εμπειρία', 1, 'published'),
(1, 1, 2, 6, 'Ειδικός Επιστήμονας - Βάσεις Δεδομένων', 'Αναζητούμε ειδικό επιστήμονα για τη διδασκαλία και έρευνα στο πεδίο των βάσεων δεδομένων', 'Πτυχίο ή μεταπτυχιακό στη σχετική ειδικότητα, ελάχιστο 2 χρόνια εμπειρία', 2, 'published'),
(1, 2, 4, 12, 'Ειδικός Επιστήμονας - Χημεία', 'Αναζητούμε ειδικό επιστήμονα για τη διδασκαλία και έρευνα στο πεδίο της χημείας', 'Διδακτορικό στην χημεία, ελάχιστο 5 χρόνια εμπειρία', 1, 'published'),
(1, 2, 5, 15, 'Ειδικός Επιστήμονας - Κλασική Μηχανική', 'Αναζητούμε ειδικό επιστήμονα για τη διδασκαλία και έρευνα στο πεδίο της κλασικής μηχανικής', 'Πτυχίο ή μεταπτυχιακό στη φυσική, ελάχιστο 3 χρόνια εμπειρία', 1, 'published');
...
-- ============================================================================
-- 10. INSERT APPLICATION FORM FIELDS
-- ============================================================================
...
(1, 3, '+357 96 123456'),
(1, 4, 'Λευκωσία, Κύπρος'),
(1, 5, 'Διπλωματούχος Μηχανικός Υπολογιστών ΠΑΝΕΠΙΣΤΗΜΙΟ ΚΥΠΡΟΥ 2020'),
