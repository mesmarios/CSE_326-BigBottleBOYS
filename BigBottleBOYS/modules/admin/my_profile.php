          ...
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item dropdown user-menu">
              <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                <img src="../../admin/assets/images/avatar.png" class="user-image rounded-circle shadow" alt="Admin" id="navAvatar" />
                ...
                <div class="config-card bg-body shadow-sm text-center">
                  <div class="config-card-body py-4">
                    ...
                    <div class="profile-avatar-upload mx-auto">
                      <img src="../../admin/assets/images/avatar.png" alt="Avatar" id="profileAvatarImg" />
